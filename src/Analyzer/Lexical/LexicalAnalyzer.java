...
public class LexicalAnalyzer {
    ...
    public List<Token> analizarLinea(String linea) {
        ...
        while (!fin.equals(tokenLectura)) {
            switch (estado) {
                case 0: {
                    // Acciones semÃ¡nticas del estado 0
                    IniLexema();
                    valor = 0;
                ...
                case 1: {
                    // Acciones semÃ¡nticas del estado 1 
                ...
                case 2: {
                    // Acciones semÃ¡nticas del estado 2 
                    RetrocesoPuntero();
                    DiferPRId(DaLexema());
                ...
                case 3: {
                    // Acciones semÃ¡nticas del estado 3
                    ConcatenarCaracter(tokenLectura);
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 4: {
                    // Acciones semÃ¡nticas del estado 4 
                    RetrocesoPuntero();
                ...
                case 5: {
                    // Acciones semÃ¡nticas del estado 5 
                    DaToken("TK_LLAV_ABR", "{");
                ...
                case 6: {
                    // Acciones semÃ¡nticas del estado 6 
                    DaToken("TK_LLAV_CER", "}");
                ...
                case 7: {
                    // Acciones semÃ¡nticas del estado 7 
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 8: {
                    // Acciones semÃ¡nticas del estado 8 
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 9: {
                    // Acciones semÃ¡nticas del estado 9 
                    DaToken("TK_FIN_SENT", /*";"*/ "$");
                ...
                case 10: {
                    // Acciones semÃ¡nticas del estado 10
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 11: {
                    // Acciones semÃ¡nticas del estado 11 
                    RetrocesoPuntero();
                    DaToken("TK_ASIGN", "=");
                ...
                case 12: {
                    // Acciones semÃ¡nticas del estado 12 
                    RetrocesoPuntero();
                    DaToken("TK_MAS", "+");
                ...
                case 13: {
                    // Acciones semÃ¡nticas del estado 13 
                    RetrocesoPuntero();
                    DaToken("TK_MENOR", "<");
                ...
                case 14: {
                    // Acciones semÃ¡nticas del estado 14 
                    DaToken("TK_PAR_ABR", "(");
                ...
                case 15: {
                    // Acciones semÃ¡nticas del estado 15 
                    DaToken("TK_PAR_CER", ")");
                ...
                case 16: {
                    // Acciones semÃ¡nticas del estado 16
                ...
                case 17: {
                    // Acciones semÃ¡nticas del estado 17
                    RetrocesoPuntero();
                ...
                case 18: {
                    // Acciones semÃ¡nticas del estado 18 
                    ConcatenarCaracter(tokenLectura);
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 19: {
                    // Acciones semÃ¡nticas del estado 19
                    ConcatenarCaracter(tokenLectura);
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 20: {
                    // Acciones semÃ¡nticas del estado 20 
                    ConcatenarCaracter(tokenLectura);
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 21: {
                    // Acciones semÃ¡nticas del estado 21 
                    ConcatenarCaracter(tokenLectura);
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 26: {
                    // Acciones semÃ¡nticas del estado 26
                    ConcatenarCaracter(tokenLectura);
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 27: {
                    //Acciones semÃ¡nticas del estado 27
                    ConcatenarCaracter(tokenLectura);
                    //DaToken("TK_COMENTARIO", tokenActual);
                    //Transiciones semÃ¡nticas del estado 27
                    estado = 0;
                    break;
                }
                case 29: {
                    //Acciones semÃ¡nticas del estado 29
                    ConcatenarCaracter(tokenLectura);
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 30: {
                    // Acciones semÃ¡nticas del estado 30 
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 31: {
                    // Acciones semÃ¡nticas del estado 31 
                    RetrocesoPuntero();
                    DaToken("TK_MENOS", "-");
                ...
                case 32: {
                    // Acciones semÃ¡nticas del estado 32
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 33: {
                    // Acciones semÃ¡nticas del estado 33 
                    RetrocesoPuntero();
                    DaToken("TK_PROD", "*");
                ...
                case 34: {
                    // Acciones semÃ¡nticas del estado 34 
                    RetrocesoPuntero();
                    DaToken("TK_DIV", "/");
                ...
                case 35: {
                    // Acciones semÃ¡nticas del estado 35
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 36: {
                    // Acciones semÃ¡nticas del estado 36
                    RetrocesoPuntero();
                    DaToken("TK_MAYOR", ">");
                ...
                case 37: {
                    // Acciones semÃ¡nticas del estado 37
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 38: {
                    // Acciones semÃ¡nticas del estado 38
                    RetrocesoPuntero();
                    DaToken("TK_DISTINTO", "<>");
                ...
                case 39: {
                    // Acciones semÃ¡nticas del estado 39
                    tokenLectura = LeerSiguienteCaracter();
                ...
                case 40: {
                    // Acciones semÃ¡nticas del estado 40 
                    RetrocesoPuntero();
                    DaToken("TK_IGUALDAD", "==");
                ...
                case 41: {
                    // Acciones semÃ¡nticas del estado 41
                    ConcatenarCaracter(tokenLectura);
                    //RetrocesoPuntero();
                ...
                case 42: {
                    // Acciones semÃ¡nticas del estado 42
                    ConcatenarCaracter(tokenLectura);
                    //RetrocesoPuntero();
        ...
        listaTokens.add(new Token("TK_SALIDA", "$EOF$")); //AÃ±ado el fin de fichero
        return listaTokens;
    }
